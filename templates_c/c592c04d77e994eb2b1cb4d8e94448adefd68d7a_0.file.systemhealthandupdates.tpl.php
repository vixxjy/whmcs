<?php
/* Smarty version 3.1.29, created on 2017-06-13 10:16:14
  from "/var/www/html/whmcs/admin/templates/blend/systemhealthandupdates.tpl" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_593fad5e02d750_06036809',
  'file_dependency' => 
  array (
...
function content_593fad5e02d750_06036809 ($_smarty_tpl) {
?>
<div class="system-health-export-buttons clearfix hidden-xs">
    <a href="?export=json" class="btn btn-link pull-right">
        <i class="fa fa-code fa-fw"></i>
        <?php echo WHMCS\Smarty::langFunction(array('key'=>"healthCheck.exportAsJson"),$_smarty_tpl);?>

    </a>
    <a href="?export=text" class="btn btn-link pull-right">
...
<div class="text-center visible-xs">
    <a href="?export=json" class="btn btn-link">
        <i class="fa fa-code fa-fw"></i>
        <?php echo WHMCS\Smarty::langFunction(array('key'=>"healthCheck.exportAsJson"),$_smarty_tpl);?>

    </a>
    <a href="?export=text" class="btn btn-link">
        <i class="fa fa-file-text-o fa-fw"></i>
        <?php echo WHMCS\Smarty::langFunction(array('key'=>"healthCheck.exportAsText"),$_smarty_tpl);?>
